...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="page-header">
        <div class="header-wrapper row m-0">
            ...
            <div class="header-logo-wrapper col-auto p-0">
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="<c:url value='/Front-end/admin/assets/images/logo/logo.png'/>" alt=""></a></div>
                ...
                <ul class="nav-menus">
                    ...
                    <li class="cart-nav onhover-dropdown">
                        ...
                        <ul class="cart-dropdown onhover-show-div">
                            ...
                            <li class="mt-0">
                                <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<c:url value='/Front-end/admin/assets/images/ecommerce/01.jpg'/>" alt="">
                            ...
                            <li class="mt-0">
                                <div class="media"><img class="img-fluid rounded-circle me-3 img-60" src="<c:url value='/Front-end/admin/assets/images/ecommerce/03.jpg'/>" alt="">
                                    <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                                        <p>Yellow(#fcb102)</p>
                                        <div class="qty-box">
                                            <div class="input-group"><span class="input-group-prepend">
                    ...
                    <li class="onhover-dropdown"><i data-feather="message-square"></i>
                        <ul class="chat-dropdown onhover-show-div">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle me-3" src="<c:url value='/Front-end/admin/assets/images/user/1.jpg'/>" alt="">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle me-3" src="<c:url value='/Front-end/admin/assets/images/user/2.jpg'/>" alt="">
                                    <div class="status-circle online"></div>
                            ...
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle me-3" src="<c:url value='/Front-end/admin/assets/images/user/4.jpg'/>" alt="">
    ...
    <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper">
            <div>
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="<c:url value='/Front-end/admin/assets/images/logo/logo.png'/>" alt=""><img class="img-fluid for-dark" src="<c:url value='/Front-end/admin/assets/images/logo/logo_dark.png'/>" alt=""></a>
...
<%--footer--%>
        ...
        <script>
            ...
            function initMap() {
                ...
                var iconBase =
                    '../Front-end/admin/assets/images/dashboard-2/';
...
<script src="<c:url value='/Front-end/admin/assets/js/prism/prism.min.js'/>"></script>
<script src="<c:url value='/Front-end/admin/assets/js/clipboard/clipboard.min.js'/>"></script>
<script src="<c:url value='/Front-end/admin/assets/js/counter/jquery.waypoints.min.js'/>"></script>
<script src="<c:url value='/Front-end/admin/assets/js/counter/jquery.counterup.min.js'/>"></script>
<script src="<c:url value='/Front-end/admin/assets/js/counter/counter-custom.js'/>"></script>
<script src="<c:url value='/Front-end/admin/assets/js/custom-card/custom-card.js'/>"></script>
<script src="<c:url value='/Front-end/admin/assets/js/owlcarousel/owl.carousel.js'/>"></script>
<script src="<c:url value='/Front-end/admin/assets/js/dashboard/dashboard_2.js'/>"></script>
