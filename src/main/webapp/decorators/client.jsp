  ...
  <%@ taglib prefix="dec" uri="http://www.opensymphony.com/sitemesh/decorator" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      <body>
              ...
              <svg viewBox="0 0 49 49" id="soda" class="product">
                <g>
                  ...
                  <path style="fill: #f75b57"
                    d="M18.5,7h-5c-0.553,0-1-0.447-1-1s0.447-1,1-1h5c0.553,0,1,0.447,1,1S19.053,7,18.5,7z"></path>
                  <path style="fill: #f75b57"
                    d="M35.5,7h-13c-0.553,0-1-0.447-1-1s0.447-1,1-1h13c0.553,0,1,0.447,1,1S36.053,7,35.5,7z"></path>
                  <path style="fill: #994530"
                    d="M18.5,45h-5c-0.553,0-1-0.447-1-1s0.447-1,1-1h5c0.553,0,1,0.447,1,1S19.053,45,18.5,45z"></path>
                  <path style="fill: #994530"
                    d="M35.5,45h-13c-0.553,0-1-0.447-1-1s0.447-1,1-1h13c0.553,0,1,0.447,1,1S36.053,45,35.5,45z"></path>
                    ...
                    <div class="header-left">
                      <div class="logo d-inline-block">
                        <a href="/home" style="width: 100%">
                          <img height="50px " src="<c:url value='/Front-end/images/logo/CameraStore-black.png'/>"
                            alt="#" />
                        </a>
                      </div>
                    </div>
                      ...
                      <div class="header-right header-right-2 d-flex align-items-center justify-content-end main-menu">
                        ...
                        <div class="header-icon header-icon-2 d-inline-block ml-30">
                          ...
                          <button type="button" data-bs-toggle="modal" data-bs-target="#cartMiniModal"
                            id="openCartList">
                            <i class="fal fa-shopping-cart"></i><span id="cartNumber">0</span>
                          </button>
                        </div>
                      </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="cartmini__wrapper">
                  ...
                  <div class="cartmini__list" style="height: 420px">
                    <ul id="cartList">
                                ...
                                --%> <%-- <div class="cartmini__content">
                                  --%> <%-- <h3 class="cartmini__title">
                                    --%> <%-- <a href="product-details.html">Form Armchair Walnut Base</a>--%> <%--
                                        ...
                                        --%> <%-- <span class="cartmini__price">--%> <%-- <span class="price">1 ×
                                            $70.00</span>--%>
                                            <%-- </span>--%> <%-- </div>
                                                --%> <%-- <a href="#" class="cartmini__remove">--%> <%-- <i
                                                    class="fal fa-times"></i>--%> <%-- </a>--%> <%-- </li>
                                                        --%>
                    </ul>
                  </div>
              ...
              success: function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                  ...
                  html +=
                    ...
                    data[i].quantity +
                    " × " +
                          nf.format(data[i].productRequest.gia)
                     +
                    " VNĐ</span>";
                  html += "</span>";
                  html += "</div>";
                ...
                $("#cartList").html(html);
                $("#ttPrice").html(nf.format(totalPrice) + " VNĐ");
              },
            });
          }
              ...
              success: function (data) {
                ...
                if (data.maKH !== null) {
                  ...
                  htmls+="<li class='has-dropdown'>"+
                          ...
                          "<ul class='has-dropdown'>"+
                          " <li>"+
                          "<a role='button' class='box-user-login' href='/logout'>Đăng xuất</a>"+
                          "</li>"+
                          "</ul>"
        ...
        <script>
          function toBrand(idBrand){
            let url =
                    window.location.protocol + "//" + window.location.host + "/product";
            let urls = new URL(url);
            urls.searchParams.set("id_brand", idBrand);
            window.location.href = urls;
          }
          function toCateWBrand(idCate,idBrand) {
            let url =
              window.location.protocol + "//" + window.location.host + "/product";
            let urls = new URL(url);
